  ...
  return (
    <section className="flex flex-col w-full items-center justify-center gap-12 px-6 py-12 bg-[#f9e6aa99] backdrop-blur-2xl">
      ...
      <div className="max-w-[1232px] flex flex-col items-center gap-4">
        <h2 className="font-header-2 font-[number:var(--header-2-font-weight)] text-paragraph-1 text-[36px] md:text-[48px] text-center tracking-[var(--header-2-letter-spacing)] leading-[40px] md:leading-[var(--header-2-line-height)] [font-style:var(--header-2-font-style)]">
